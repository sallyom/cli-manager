...
type CliManagerSpec struct {
	...
	// Foo is an example field of CliManager. Edit CliManager_types.go to remove/update
...
// CliManager is the Schema for the climanagers API
...
func init() {
	SchemeBuilder.Register(&CliManager{}, &CliManagerList{})
}
